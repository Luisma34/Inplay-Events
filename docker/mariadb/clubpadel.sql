...
-- Dumping data for table club_padel.clase: ~0 rows (approximately)
DELETE FROM `clase`;
...
-- Dumping data for table club_padel.sesion: ~0 rows (approximately)
DELETE FROM `sesion`;
...
-- Dumping data for table club_padel.usuario: ~3 rows (approximately)
DELETE FROM `usuario`;
